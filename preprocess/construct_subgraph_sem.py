...
def generate_adj_data_from_grounded_concepts(grounded_path, cpnet_graph_path, cpnet_vocab_path, output_path,
                                             num_processes):
    ...
    global cui2idx, idx2cui, relation2id, id2relation, cpnet_simple, cpnet
...
if __name__ == '__main__':
    ...
    os.system(f'mkdir -p {kg_root}/graph')
    for fname in ["test", "train"]:
        ...
        output_path = f"{kg_root}/graph/{fname}_sem.graph.adj.pk"
