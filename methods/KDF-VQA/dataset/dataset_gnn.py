...
class Binary_VQA_Dataset(Dataset):
    def __init__(self, csv_path, adj_path, img_root_dir, image_res, is_blank=True, is_train=True):
        ...
        self.transform = transforms.Compose([
            transforms.RandomResizedCrop([image_res, image_res], scale=(0.2, 1.0),
    ...
    def __getitem__(self, index):
        ...
        bert_input = question
        # bert_label = answer_label.lower()
        bert_label = answer.lower()
