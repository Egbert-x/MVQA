...
import transformers
from Dataset.Slake_Dataset_triples import Slake_Dataset_triples
...
@dataclass
class DataArguments:
    img_dir: str = field(default='../../../PMC-VQA/Slake1.0_new/imgs/', metadata={"help": "Path to the training data."})
    # Test_csv_path: str = field(default='../../../PMC-VQA/Slake1.0_new/test_close.csv', metadata={"help": "Path to the training data."})
    Test_csv_path: str = field(default='../../../PMC-VQA/Slake1.0_new/test.csv', metadata={"help": "Path to the training data."})
    Test_triples_path: str = field(default='../../../PMC-VQA/Slake1.0_new/triples/test_sem.triples.json', metadata={"help": "Path to the training data."})
...
def main():
    ...
    Test_dataset = Slake_Dataset_triples(data_args.img_dir, data_args.Test_csv_path, data_args.Test_triples_path,
                                               data_args.tokenizer_path, mode='Test', text_type='blank',
                                               start=row_count)
    ...
    # Test_dataset_close = Slake_Dataset_triples(data_args.img_dir, data_args.Test_csv_path, data_args.Test_triples_path, data_args.tokenizer_path, mode='Test', text_type='blank', start=row_count)
    # 
    # # batch size should be 1
    ...
    #     drop_last=False,
    # )
    # Test_dataset_open = Slake_Dataset_triples(data_args.img_dir, data_args.Test_csv_path.replace('close.csv', 'open.csv'), data_args.Test_triples_path, data_args.tokenizer_path, mode='Test', text_type='blank', start=row_count)
    # 
    # # batch size should be 1
