...
class VQA_RAD_Dataset_triples(Dataset):
    def __init__(self, img_dir, csv_path, triples_path, tokenizer_path, img_tokens=32, seq_length=512, voc_size=32000, mode='Train', start=0, text_type='blank'):
    ...
    def random_answer(self, Prompt, Question, Answer):
        Answer = str(Answer)
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'Train':
            pre_text, final_o = self.random_answer(Prompt, Question, Anwser)
